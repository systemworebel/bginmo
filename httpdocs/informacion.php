...
<div class="wrapper">
    ...
    <div class="navigation">
        <div class="secondary-navigation">
            <div class="container">
                <div class="contact">
                    <figure><strong>Teléfono:</strong><img alt="numero whatsap" src="assets/img/whtsp.png">3014057660 / 3188217589</figure>
                    <figure><strong>Email:</strong>gerencia@bginmo.com</figure>
                </div>
                <div class="user-area">
                    <div class="actions">
            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="servicios.html">Servicios</a>
                            <ul class="child-navigation">
                        ...
                        <li class="has-child"><a href="proyectos.html">Proyectos</a>
                            <ul class="child-navigation">
                        ...
                        <!--<li><a href="submit.html">Noticias</a></li>-->
                        <!--<li class="has-child"><a href="#">Noticias</a>
                            <ul class="child-navigation">
...
$idInfo=$_GET['idAviso'];
if(isset($idInfo) and $idInfo!='' and $idInfo!='0'){
$infoAvisos='SELECT*FROM imagenes WHERE id="'.$idInfo.'"';
$paqueteRecibido=mysql_query($infoAvisos);
$i=0;
        ...
        for($j=0;$j<$i;$j++){
            echo '                    <section id="property-detail">
                        <header class="property-title">
                            <h1>'.$datosImagenes[1][$j].'</h1>
                            <figure>'.$datosImagenes[15][$j].'</figure>
                        </header>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <section id="quick-summary" class="clearfix">
                                    ...
                                    <dl>
                                        ...
                                        <dt>Parqueadero:</dt>
                                            <dd>'.$datosImagenes[14][$j].'</dd>
                                    </dl>
                                </section><!-- /#quick-summary -->
                            </div><!-- /.col-md-4 -->
                            <div class="col-md-8 col-sm-12">
                                <section id="description">
                                    <header><h2>Descripción del Inmueble</h2></header>
                                    <p>'.$datosImagenes[2][$j].'</p>
                                </section><!-- /#description -->
                                <section id="property-features">
                                    <header><h2>Caracteristicas</h2></header>
                                    <ul class="list-unstyled property-features-list">'.$datosImagenes[3][$j].'</ul>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <section id="contact-agent">
                                    <header><h2>Datos de Contacto</h2></header>
                                    <div class="row">
                ...
                <div class="col-md-3 col-sm-3">
                    <section id="sidebar">
                        ...
                        <aside id="our-guides">
                            ...
                            </a>                            <a href="#" class="universal-button">
      ...
      <footer id="page-footer">
        <div class="inner">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <article>
                                <h3>Nosotros</h3>
                                <p>Empresa de servicios inmobiliarios integrales constituida en el año 2014, nuestros servicios están enfocados a la comercialización de inmuebles para vivienda, uso comercial y administración de arriendos.
                                </p>
                                <hr>
                                <a href="#" class="link-arrow">Leer Más</a>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                <address>
                                    ...
                                    <img alt="numero whatsap" src="assets/img/whtsp.png">301 4057660 / 318 8217589
                                    <a href="#">gerencia@bginmo.com</a>
                                </address>
                                </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
            ...
            <aside id="footer-copyright">
                <div class="container">
                    <span>Desarrollado por Worebel @2015</span>
                    <span class="pull-right"><a href="#page-top" class="roll">Subir</a></span>
                </div>
            </aside>
        </div><!-- /.inner -->
    </footer>
